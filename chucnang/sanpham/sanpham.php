    ...
    <div class="row">
        ...
        ?>
            <div class="col-md-3 col-sm-6 product-item text-center">
                ...
                <p>Bảo Hành: <?php echo $row['bao_hanh'];?></p>
...
?>
<div class="products">
     <h2 class="h2-bar">Sản Phẩm Mới</h2>
    <div class="row">
        <?php
            while ( $row2 = mysqli_fetch_array($query2)){
        ?>
            <div class="col-md-3 col-sm-6 product-item text-center">
                <a href="index.php?page_layout=chitietsp&id_sp=<?php echo $row2['id_sp']; ?>">
                    <img width="80" height="144" src="quantri/anh/<?php echo $row2['anh_sp']; ?>"></a>
                <h3><a href="index.php?page_layout=chitietsp&id_sp=<?php echo $row2['id_sp']; ?>">
                    <?php echo $row2['ten_sp']; ?></a></h3>
                <p>Bảo Hành: <?php echo $row2['bao_hanh']; ?></p>
                <p>Tình Trạng: <?php echo $row2['tinh_trang']; ?></p>
                <p class="price">Giá: <?php echo number_format($row2['gia_sp'],0,',','.') ?> VNĐ </p>
            </div>
        <?php
            }
        ?>
